...
import { EmbeddableQuestionFeedbackResponse } from '@koh/common'
...
export default function EmbeddableQuestionFeedback({
  ...
  const handleSubmit = async () => {
    ...
    try {
      let response: EmbeddableQuestionFeedbackResponse;
      if (assignmentId) {
        response = await API.lti.embeddableQuestion.assignment.getFeedback(courseId,assignmentId,questionId,trimmed)
      } else {
        response = await API.lti.embeddableQuestion.getFeedback(
          courseId,
          questionId,
          trimmed,
        )
