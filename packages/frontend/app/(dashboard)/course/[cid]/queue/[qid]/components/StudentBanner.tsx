...
const StudentBanner: React.FC<StudentBannerProps> = ({
  ...
  return (
    <div className="mb-1 w-full md:mb-0">
      <div className="relative  flex min-h-[3rem] items-center justify-between rounded-t-md bg-[#3684C6] pl-4 pr-1.5 shadow-md md:min-h-14 md:pl-6">
