 ...
 */
const QueueConfigHelp: React.FC = () => {
  return (
    <Collapse className="bg-gray-100" bordered={false} items={items}></Collapse>
  )
}

export default QueueConfigHelp
