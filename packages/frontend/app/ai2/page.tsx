...
export default function Home(): ReactElement {
  return (
    <>
      ...
      <main className="ambient-glow min-h-screen bg-[#f8f9fb] pb-20">
        {/* Hero Section */}
        <div className="mx-auto max-w-4xl px-4 pb-16 pt-12 text-center md:pb-24 md:pt-20">
          <div className="mb-6 inline-flex animate-pulse items-center gap-1.5 rounded-full border border-blue-100 bg-blue-50 px-3.5 py-1 text-xs font-semibold text-blue-600">
            ✨ Academic Assistant Platform
          </div>
          ...
          <p className="mx-auto mt-4 max-w-md text-lg font-medium tracking-tight text-slate-500 md:text-xl">
            A Course Help System
          </p>

          <Button
            type="primary"
            className="from-helpmeblue to-helpmeblue-light mx-auto mb-4 mt-8 flex h-12 items-center gap-2 rounded-lg border-0 bg-gradient-to-r px-8 text-base font-semibold shadow-lg shadow-blue-500/20 transition-all duration-200 hover:scale-[1.02] hover:shadow-blue-500/30 active:scale-[0.98]"
            href="/login"
            size="large"
            icon={<LogIn strokeWidth={1.5} className="h-5 w-5" />}
          >
            Login
          </Button>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-16 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Discover how HelpMe enhances the course experience
            </p>
            <div className="from-helpmeblue to-helpmeblue-light mx-auto mt-4 h-1 w-12 rounded-full bg-gradient-to-r"></div>
          </div>

          <div className="space-y-12">
            {/* Feature 1: Course Chatbot */}
            <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-md md:p-10">
              <div className="flex flex-col items-center gap-8 lg:flex-row lg:gap-16">
                <div className="flex-grow space-y-6 text-left">
                  ...
                  <ul className="space-y-3.5">
                    {[
                      ...
                      'Prompt is professor-customizable',
                      ...
                      <li key={idx} className="flex items-start gap-3">
                        <span className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-500">
                          <svg
                            className="h-3 w-3"
                            fill="none"
                            viewBox="0 0 24 24"
                ...
                <div className="w-full flex-shrink-0 lg:w-[50%]">
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                response with a citation to the uploaded
                                Syllabus. They also have the option to convert
                                the question to an Anytime Question if they want
                                further help from course staff or discuss with
                                other students.
                              </p>
                            </div>
                          ),
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                many file types (.pdf, .docx, .pptx, .xlsx,
                                .csv, .txt, .md, and most image formats).
                              </p>
                            </div>
                          ),
                        },
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                HelpMe Course Chatbot&apos;s Knowledge Base.
                                Items include: Announcements, Assignments,
                                Files, Pages, and Quizzes, with options to
                                customize what items are synchronized. Also lets
                                you compare what students are in your HelpMe
                                course but not in your Canvas course, or
                                vise-versa.
                              </p>
                            </div>
                          ),
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                include course-specific instructions, such as
                                what the course is, what the goals of the course
                                are (at a high level), how you want the chatbot
                                to respond, and why it&apos;s important for the
                                chatbot to respond that way to meet the
                                course&apos;s goals. They can also choose
                                different models for more advanced
                                configuration.
                              </p>
                            </div>
                          ),
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                students are struggling <i>and</i> is
                                student-data safe!
                              </p>
                            </div>
                          ),
              ...
              <div className="flex flex-col items-center gap-8 lg:flex-row-reverse lg:gap-16">
                <div className="flex-grow space-y-6 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-slate-600">
                      Queueing system for managing Online/In-Person/Hybrid
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                questions in the queue, including: delete, ask
                                to rephrase, message student, and start helping.
                              </p>
                            </div>
                          ),
                        },
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                Insights) and whether they are asking the
                                question In-Person or Online (for Hybrid
                                queues).
                              </p>
                            </div>
                          ),
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                following options: requeue, can&apos;t find,
                                done helping, and pause.
                              </p>
                            </div>
                          ),
                        },
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                getting help online, they will have the option
                                to join the online meeting. Any professor-set
                                queue notes are also listed here in case the
                                professor has additional instructions for the
                                student.
                              </p>
                            </div>
                          ),
            ...
            <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-md md:p-10">
              <div className="flex flex-col items-center gap-8 lg:flex-row lg:gap-16">
                <div className="flex-grow space-y-6 text-left">
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-purple-100 bg-purple-50 px-3 py-1 text-xs font-semibold text-purple-600">
                    Discussion Board
                  </span>
                  <div>
                    <h3 className="mb-2 text-2xl font-bold text-slate-900">
                    ...
                    <p className="text-sm leading-relaxed text-slate-600">
                      A discussion board/email replacement where students first
                      get a chatbot answer and can then decide if they are
                      satisfied or still need more help
                    </p>
                  </div>
                </div>
                <div className="w-full flex-shrink-0 lg:w-[50%]">
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                students have asked. It shows which ones have
                                been human verified vs which ones got an AI
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                (by default, all questions are private unless
                                made public by course staff).
                              </p>
                            </div>
                          ),
                        },
                        {
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                Once created, the student can view the AI
                                answer. They can then decide whether they are
                                satisfied with the response or still need
                                faculty help. Choosing the latter will send an
                                email notification to the course staff to
                                provide an answer.
                              </p>
                            </div>
                          ),
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                ...
                                mark it as verified. Once saved, the student
                                will be email notified. They also have the
                                option to make the question visible to other
                                students (the student will still be anonymized).
                              </p>
                            </div>
                          ),
                        },
                        {
                          ...
                          caption: (
                            <div>
                              ...
                              <p className="text-sm">
                                Anytime Questions also supports Comments,
                                allowing course staff (or students for public
              ...
              <div className="flex flex-col items-center gap-8 lg:flex-row-reverse lg:gap-16">
                <div className="flex-grow space-y-6 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-slate-600">
                      Insights for letting you see usage, what types of
          ...
          {/* About / Credits Card */}
          <div className="mx-auto my-16 max-w-4xl rounded-3xl border border-slate-100 bg-white p-6 text-left shadow-sm md:p-10">
            ...
            <ul className="space-y-4 text-slate-600">
              <li className="flex items-start gap-3">
                <span className="mt-1 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-500">
                  <svg
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm leading-relaxed text-slate-700">
                  For new professors, please watch the video(s) below and
                  contact Ramon Lawrence at{' '}
                  <a
                    href="mailto:ramon.lawrence@ubc.ca"
                    className="text-helpmeblue font-semibold hover:underline"
                  >
                    ramon.lawrence@ubc.ca
                  </a>{' '}
                  for more information if interested. It&apos;s free to add to
                  your UBC courses.
                </span>
              </li>
            </ul>
          ...
          <div className="my-16">
            <div className="mb-10 text-center">
              <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">
                Showcase & Video Guides
              </h2>
              <div className="from-helpmeblue to-helpmeblue-light mx-auto mt-3 h-1 w-12 rounded-full bg-gradient-to-r"></div>
            </div>

            <div className="mx-auto mt-10 grid max-w-5xl grid-cols-1 gap-8 px-4 md:grid-cols-2">
              {/* Video Card 1 */}
              <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="border-b border-slate-50 bg-slate-50/50 p-5">
                  <h4 className="text-base font-bold text-slate-800">
                    HelpMe Overview
                  </h4>
                </div>
                <div className="p-5">
                  <div className="youtube-video-container overflow-hidden rounded-2xl border border-slate-100 shadow-inner">
                    <iframe
