  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "lms_assignment_model" ("id" integer NOT NULL, "courseId" integer NOT NULL, "lmsSource" TEXT NOT NULL, "name" text NOT NULL, "description" text NOT NULL DEFAULT '', "due" TIMESTAMP, "modified" TIMESTAMP NOT NULL, "chatbotDocumentId" text, "uploaded" TIMESTAMP, "syncEnabled" BOOLEAN DEFAULT(TRUE) NOT NULL, CONSTRAINT "PK_632eb1b1362c2e5d805db6ea013" PRIMARY KEY ("id", "courseId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "lms_announcement_model" ("id" integer NOT NULL, "courseId" integer NOT NULL, "lmsSource" TEXT NOT NULL, "title" text NOT NULL, "message" text NOT NULL, "posted" TIMESTAMP NOT NULL, "modified" TIMESTAMP NOT NULL, "chatbotDocumentId" text, "uploaded" TIMESTAMP, "syncEnabled" BOOLEAN DEFAULT(TRUE) NOT NULL, CONSTRAINT "PK_e7f4f6a5247a4f577585d84bbfa" PRIMARY KEY ("id", "courseId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "lms_course_integration_model" ("courseId" integer NOT NULL, "apiCourseId" text NOT NULL, "apiKey" text NOT NULL, "apiKeyExpiry" TIMESTAMP, "lmsSynchronize" boolean NOT NULL DEFAULT false, "orgIntegrationOrganizationId" integer, "orgIntegrationApiPlatform" TEXT, CONSTRAINT "REL_594c79fce72d04560c3a4465ea" UNIQUE ("courseId"), CONSTRAINT "PK_594c79fce72d04560c3a4465ea6" PRIMARY KEY ("courseId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "lms_org_integration_model" ("organizationId" integer NOT NULL, "apiPlatform" TEXT NOT NULL, "rootUrl" text NOT NULL, CONSTRAINT "PK_8f17bd650afb1438b091dfde758" PRIMARY KEY ("organizationId", "apiPlatform"))`,
    );
    await queryRunner.query(
