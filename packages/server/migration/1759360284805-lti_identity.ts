...
export class LtiIdentity1759360284805 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "lti_identity_token_model" ("code" text NOT NULL, "issuer" text NOT NULL, "ltiUserId" text NOT NULL, "ltiEmail" text, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "expiresInSeconds" integer DEFAULT '600', CONSTRAINT "PK_a241acc007983e4ae6d123a2b51" PRIMARY KEY ("code"))`,
    );
    await queryRunner.query(
