...
const CreateAdminAlertsPage: React.FC = () => {
  ...
  const handleDelete = async (sentAt: Date) => {
    ...
    mutateExistingAdminAlerts(
      (existingAdminAlerts || []).filter(
        (a) => new Date(a.sentAt).toISOString() !== sentAtStr,
      ),
      { revalidate: false },
    )
      ...
      <div className="p-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Create alerts targeting any number of users in the system. You can
              choose to make it a Modal alert or a Feed alert.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <Form.Item<FormValues> label="Target Type" name="targetType">
            <Segmented<TargetType> options={['User', 'Course', 'Org', 'All']} />
          </Form.Item>
          ...
          columns={[
            ...
            },
            {
              ...
              render: (_: any, record: GetAdminNoticeAlert) => {
                ...
                if (target.courseId !== undefined && target.courseId !== null) {
                  return (
                    <Space direction="vertical" size={2}>
                      <div>
