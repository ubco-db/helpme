  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    /* SQL
        ...
        FROM (SELECT "organization_user_model"."userId", "organization_user_model"."organizationId", "organization_user_model"."role" FROM "organization_user_model") AS "subquery"
        ...
        ALTER TABLE "user_model" ADD CONSTRAINT "UQ_userEmailOrganizationId" UNIQUE ("email","organizationId");
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    /* SQL
        ...
        INSERT INTO "organization_user_model"
