...
> = ({ courseId, open, onCancel, onCreateOrUpdateQuestion, chatbotQ }) => {
  ...
  useEffect(() => {
    if (open) {
      // Set the question text immediately
      form.setFieldsValue({ questionText })

      // Asynchronously generate the abstract
  ...
  return (
    ...
    >
      <Form.Item
        ...
        tooltip="A short summary of your question, auto-generated by AI. You can edit it if you'd like."
        required={true}
        rules={[
        ...
        <Input
          placeholder={
            isGeneratingAbstract
              ? 'Generating abstract...'
              : 'AI will generate an abstract based on your question'
          }
