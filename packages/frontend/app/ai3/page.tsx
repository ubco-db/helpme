...
export default function Home(): ReactElement {
  return (
    <>
      <header className="sticky top-0 z-[100] border-b border-zinc-200/80 bg-white/95 shadow-sm backdrop-blur-md">
      ...
      <main className="min-h-screen bg-[#f8f9fb] pb-20">
        {/* Hero Section */}
        <div className="relative mx-auto max-w-6xl overflow-hidden px-4 pb-20 pt-16 text-center sm:px-6 lg:px-8">
          {/* Subtle background glow */}
          <div className="bg-helpmeblue/10 pointer-events-none absolute left-[50%] top-[-10%] h-[300px] w-[500px] -translate-x-[50%] rounded-full blur-[100px]" />

          <div className="relative z-10 flex flex-col items-center">
            {/* Premium badge */}
            <div className="bg-helpmeblue/10 text-helpmeblue border-helpmeblue/20 mb-6 inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-wide">
              ✨ The Modern Course Assistant
            </div>

            <h1 className="mb-4 font-sans text-4xl font-extrabold leading-tight tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
              Welcome to{' '}
              <span className="from-helpmeblue to-helpmeblue-light bg-gradient-to-r bg-clip-text text-transparent">
                HelpMe
              </span>
            </h1>

            <p className="mx-auto mb-8 max-w-xl text-lg font-medium text-slate-500 sm:text-xl">
              A Course Help System
            </p>

            <Button
              type="primary"
              className="shadow-helpmeblue/20 from-helpmeblue to-helpmeblue-light animate-fade-in flex h-12 items-center justify-center gap-2 rounded-lg border-0 bg-gradient-to-r px-8 text-base font-semibold shadow-md transition-all duration-200 hover:scale-105 hover:opacity-90 active:scale-95"
              href="/login"
              size="large"
              icon={<LogIn strokeWidth={1.5} className="mt-0.5 h-5 w-5" />}
            >
              Login
            </Button>
          </div>
        ...
        <div className="mx-auto max-w-6xl space-y-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="to-helpmeblue/[0.03] flex flex-col items-center gap-8 rounded-3xl border border-slate-100 bg-gradient-to-br from-white via-white p-6 shadow-sm transition-all duration-300 hover:shadow-md md:flex-row md:gap-12 md:p-10">
            <div className="flex w-full flex-col items-start justify-center text-left md:flex-1">
              <div className="mb-3 flex items-center gap-2">
                <div className="bg-helpmeblue/10 text-helpmeblue rounded-xl p-2">
                  <Bot className="h-5 w-5" />
                </div>
                <span className="text-helpmeblue text-xs font-semibold uppercase tracking-wider">
                  Course Assistant
                </span>
              </div>
              ...
              <ul className="w-full space-y-3.5">
                <li className="flex items-start gap-3">
                  <div className="bg-helpmeblue/10 text-helpmeblue mt-1 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full">
                    <Check className="h-3 w-3 stroke-[3]" />
                  </div>
                  <span className="text-sm leading-relaxed text-slate-600 md:text-[15px]">
            ...
            <div className="w-full overflow-hidden rounded-2xl border border-slate-100 bg-white p-2 shadow-sm md:flex-1">
              <ImageCarousel
                images={[
                  {
          ...
          <div className="flex flex-col items-center gap-8 rounded-3xl border border-slate-100 bg-gradient-to-br from-white to-slate-50 p-6 shadow-sm transition-all duration-300 hover:shadow-md md:flex-row-reverse md:gap-12 md:p-10">
            <div className="flex w-full flex-col items-start justify-center text-left md:flex-1">
              <div className="mb-3 flex items-center gap-2">
        ...
        {/* Development Info & Contact Banner */}
        <div className="mx-auto mt-16 max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-8 text-center shadow-sm">
            <div className="bg-helpmeblue/5 pointer-events-none absolute right-0 top-0 h-24 w-24 rounded-full blur-xl" />
            <div className="bg-helpmeblue-light/5 pointer-events-none absolute bottom-0 left-0 h-24 w-24 rounded-full blur-xl" />

            <div className="relative z-10 flex flex-col items-center">
              <div className="bg-helpmeblue/10 text-helpmeblue mb-4 flex h-12 w-12 items-center justify-center rounded-full">
              ...
              <p className="mb-4 max-w-xl text-[15px] leading-relaxed text-slate-600">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-slate-600 md:text-[15px]">
                ...
                <a
                  ...
                  className="text-helpmeblue hover:text-helpmeblue-light inline-flex items-center gap-1 font-semibold transition-colors hover:underline"
                >
                  ramon.lawrence@ubc.ca <Mail className="inline h-4 w-4" />
                </a>{' '}
        ...
        <div className="mx-auto mt-20 max-w-6xl px-4 sm:px-6 lg:px-8">
          <h3 className="mb-8 text-center text-2xl font-extrabold text-slate-900">
            Learn More About HelpMe
          </h3>

          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2">
            {/* Video Card 1 */}
            <div className="flex flex-col rounded-3xl border border-slate-100 bg-white p-5 shadow-sm transition-all duration-300 hover:shadow-md">
